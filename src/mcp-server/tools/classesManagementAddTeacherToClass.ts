...
export const tool$classesManagementAddTeacherToClass: ToolDefinition<
  typeof args
> = {
  name: "classes-management-add-teacher-to-class",
...
Enrolls a teacher to a specific Class. The responding system must return the set of sourcedIds that have been allocated to the newly created enrollment record.`,
  ...
  tool: async (client, args, ctx) => {
    const [result, apiCall] = await classesManagementAddTeacherToClass(
      client,
      args.request,
