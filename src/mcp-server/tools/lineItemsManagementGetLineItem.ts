...
export const tool$lineItemsManagementGetLineItem: ToolDefinition<typeof args> =
  {
    name: "line-items-management-get-line-item",
...
Get a specific Line Item on the service provider. If the corresponding record cannot be located, the api will return a 404 error code and message 'Line item not found.'`,
    ...
    tool: async (client, args, ctx) => {
      const [result, apiCall] = await lineItemsManagementGetLineItem(
        client,
        args.request,
