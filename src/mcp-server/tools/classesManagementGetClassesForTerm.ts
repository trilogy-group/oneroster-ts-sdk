...
export const tool$classesManagementGetClassesForTerm: ToolDefinition<
  typeof args
> = {
  name: "classes-management-get-classes-for-term",
...
To get the set of Classes related to a specific Term. If the specified term cannot be identified within the service provider, the api will return a 404 error code and message 'Term not found.'`,
  ...
  tool: async (client, args, ctx) => {
    const [result, apiCall] = await classesManagementGetClassesForTerm(
      client,
      args.request,
