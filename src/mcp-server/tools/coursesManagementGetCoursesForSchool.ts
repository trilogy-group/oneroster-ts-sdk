...
export const tool$coursesManagementGetCoursesForSchool: ToolDefinition<
  typeof args
> = {
  name: "courses-management-get-courses-for-school",
...
To get all Courses for a School on the service provider. If the specified school cannot be identified within the service provider, the api will return a 404 error code and message 'School not found.'`,
  ...
  tool: async (client, args, ctx) => {
    const [result, apiCall] = await coursesManagementGetCoursesForSchool(
      client,
      args.request,
