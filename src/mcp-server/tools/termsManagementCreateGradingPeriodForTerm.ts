...
export const tool$termsManagementCreateGradingPeriodForTerm: ToolDefinition<
  typeof args
> = {
  name: "terms-management-create-grading-period-for-term",
...
To create a new Grading Period for a Term. A Grading Period is a type of Academic Session. The responding system must return the set of sourcedIds that have been allocated to the newly created academicSession record.`,
  ...
  tool: async (client, args, ctx) => {
    const [result, apiCall] = await termsManagementCreateGradingPeriodForTerm(
      client,
      args.request,
