...
export const tool$studentsManagementGetStudentsForClass: ToolDefinition<
  typeof args
> = {
  name: "students-management-get-students-for-class",
...
To get all students enrolled in a specific Class. If the corresponding record cannot be located, the api will return a 404 error code and message 'Class not found.'`,
  ...
  tool: async (client, args, ctx) => {
    const [result, apiCall] = await studentsManagementGetStudentsForClass(
      client,
      args.request,
