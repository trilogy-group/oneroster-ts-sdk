...
export const tool$gradingPeriodsManagementGetGradingPeriodsForTerm:
  ToolDefinition<typeof args> = {
    name: "grading-periods-management-get-grading-periods-for-term",
...
To get the set of Grading Periods related to a specific Term. If the specified Term cannot be identified within the service provider, the api will return a 404 error code and message 'Term not found.'`,
    ...
    tool: async (client, args, ctx) => {
      const [result, apiCall] =
        await gradingPeriodsManagementGetGradingPeriodsForTerm(
          client,
          args.request,
