...
export const tool$assessmentLineItemsDelete: ToolDefinition<typeof args> = {
  name: "assessment-line-items-delete",
  description:
...
Perform a soft delete on a specific Assessment Line Item on the service provider. This operation changes the status of the Assessment Line Item to 'tobedeleted'.`,
  ...
  tool: async (client, args, ctx) => {
    const [result, apiCall] = await assessmentLineItemsDelete(
      client,
      args.request,
