...
export const tool$resourcesManagementCreateResource: ToolDefinition<
  typeof args
> = {
  name: "resources-management-create-resource",
...
To create a new resource. The responding system must return the set of sourcedIds that have been allocated to the newly created resource record.`,
  ...
  tool: async (client, args, ctx) => {
    const [result, apiCall] = await resourcesManagementCreateResource(
      client,
      args.request,
