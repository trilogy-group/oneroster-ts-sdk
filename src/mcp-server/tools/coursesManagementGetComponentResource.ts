...
export const tool$coursesManagementGetComponentResource: ToolDefinition<
  typeof args
> = {
  name: "courses-management-get-component-resource",
...
Get a specific Component Resource on the service provider. If the corresponding record cannot be located, the api will return a 404 error code and message 'Component Resource not found.'`,
  ...
  tool: async (client, args, ctx) => {
    const [result, apiCall] = await coursesManagementGetComponentResource(
      client,
      args.request,
