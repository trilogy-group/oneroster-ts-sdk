...
export const tool$enrollmentsManagementCreateEnrollment: ToolDefinition<
  typeof args
> = {
  name: "enrollments-management-create-enrollment",
...
To create a new Enrollment. The responding system must return the set of sourcedIds that have been allocated to the newly created enrollment record.`,
  ...
  tool: async (client, args, ctx) => {
    const [result, apiCall] = await enrollmentsManagementCreateEnrollment(
      client,
      args.request,
