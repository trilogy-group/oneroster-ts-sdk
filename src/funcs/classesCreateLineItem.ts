 ...
 */
export function classesCreateLineItem(
  client: OneRosterCore,
  request: operations.PostLineItemsForClassRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.PostLineItemsForClassResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PostLineItemsForClassRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, operations.PostLineItemsForClassResponse$inboundSchema),
