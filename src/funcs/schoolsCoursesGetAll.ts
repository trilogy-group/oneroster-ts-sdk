 ...
 */
export function schoolsCoursesGetAll(
  client: OneRosterCore,
  request: operations.GetCoursesForSchoolRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    Array<operations.GetCoursesForSchoolResponse>,
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, z.array(operations.GetCoursesForSchoolResponse$inboundSchema)),
