 ...
 */
export function resourcesClassesAssign(
  client: OneRosterCore,
  request: operations.AssignResourceToClassRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AssignResourceToClassResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AssignResourceToClassRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, operations.AssignResourceToClassResponse$inboundSchema),
