 ...
 */
export function courseResourcesDelete(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.RemoveResourceFromCourseRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    ...
    resourceSourcedId: encodeSimple(
      "resourceSourcedId",
      payload.resourceSourcedId,
