# ResourcesClassesManagement
(*resourcesClassesManagement*)

## Overview

This enables the management of resources for classes.

### Available Operations

* [getResourcesForClass](#getresourcesforclass) - Get resources for a class
* [assignResourceToClass](#assignresourcetoclass) - Assign a resource to a class
* [removeResourceFromClass](#removeresourcefromclass) - Remove a resource from a class
...
async function run() {
  const result = await oneRoster.resourcesClassesManagement.getResourcesForClass({
    classSourcedId: "<id>",
...
import { resourcesClassesManagementGetResourcesForClass } from "@superbuilders/oneroster/funcs/resourcesClassesManagementGetResourcesForClass.js";
...
async function run() {
  const res = await resourcesClassesManagementGetResourcesForClass(oneRoster, {
    classSourcedId: "<id>",
    fields: "sourcedId,name",
    filter: "status='active'",
  });
...
async function run() {
  const result = await oneRoster.resourcesClassesManagement.assignResourceToClass({
    classSourcedId: "<id>",
    requestBody: {
      resource: {
        sourcedId: "<id>",
...
```typescript
import { OneRosterCore } from "@superbuilders/oneroster/core.js";
import { resourcesClassesManagementAssignResourceToClass } from "@superbuilders/oneroster/funcs/resourcesClassesManagementAssignResourceToClass.js";
...
async function run() {
  const res = await resourcesClassesManagementAssignResourceToClass(oneRoster, {
    classSourcedId: "<id>",
    requestBody: {
      resource: {
        sourcedId: "<id>",
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.AssignResourceToClassRequest](../../models/operations/assignresourcetoclassrequest.md)                                                                             | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[operations.AssignResourceToClassResponse](../../models/operations/assignresourcetoclassresponse.md)\>**
...
async function run() {
  const result = await oneRoster.resourcesClassesManagement.removeResourceFromClass({
    classSourcedId: "<id>",
...
```typescript
import { OneRosterCore } from "@superbuilders/oneroster/core.js";
import { resourcesClassesManagementRemoveResourceFromClass } from "@superbuilders/oneroster/funcs/resourcesClassesManagementRemoveResourceFromClass.js";
...
async function run() {
  const res = await resourcesClassesManagementRemoveResourceFromClass(oneRoster, {
    classSourcedId: "<id>",
    resourceSourcedId: "<id>",
  });
