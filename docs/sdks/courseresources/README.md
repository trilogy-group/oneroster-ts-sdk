...
* [delete](#delete) - Remove a resource from a course
...
async function run() {
  const result = await oneRoster.courseResources.delete({
    courseSourcedId: "<id>",
...
import { courseResourcesDelete } from "@superbuilders/oneroster/funcs/courseResourcesDelete.js";
...
async function run() {
  const res = await courseResourcesDelete(oneRoster, {
    courseSourcedId: "<id>",
    resourceSourcedId: "<id>",
  });
