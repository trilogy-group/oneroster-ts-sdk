...
* [getAll](#getall) - The REST read request message for the getAllCategories() API call.
* [create](#create) - The REST create request message for the createCategory() API call.
* [get](#get) - The REST read request message for the getCategory() API call.
* [update](#update) - The REST update request message for the updateCategory() API call.
* [delete](#delete) - The REST delete request message for the deleteCategory() API call.
...
async function run() {
  const result = await oneRoster.categories.getAll();
...
import { categoriesGetAll } from "@superbuilders/oneroster/funcs/categoriesGetAll.js";
...
async function run() {
  const res = await categoriesGetAll(oneRoster);
...
async function run() {
  const result = await oneRoster.categories.create({
    category: {
      status: "active",
      title: "<value>",
    },
...
```typescript
import { OneRosterCore } from "@superbuilders/oneroster/core.js";
import { categoriesCreate } from "@superbuilders/oneroster/funcs/categoriesCreate.js";
...
async function run() {
  const res = await categoriesCreate(oneRoster, {
    category: {
      status: "active",
      title: "<value>",
    },
...
async function run() {
  const result = await oneRoster.categories.get({
    sourcedId: "<id>",
  });
...
```typescript
import { OneRosterCore } from "@superbuilders/oneroster/core.js";
import { categoriesGet } from "@superbuilders/oneroster/funcs/categoriesGet.js";
...
async function run() {
  const res = await categoriesGet(oneRoster, {
    sourcedId: "<id>",
  });
...
async function run() {
  const result = await oneRoster.categories.update({
    sourcedId: "<id>",
    requestBody: {
      category: {
        status: "active",
...
```typescript
import { OneRosterCore } from "@superbuilders/oneroster/core.js";
import { categoriesUpdate } from "@superbuilders/oneroster/funcs/categoriesUpdate.js";
...
async function run() {
  const res = await categoriesUpdate(oneRoster, {
    sourcedId: "<id>",
    requestBody: {
      category: {
        status: "active",
...
async function run() {
  await oneRoster.categories.delete({
    sourcedId: "<id>",
  });
...
```typescript
import { OneRosterCore } from "@superbuilders/oneroster/core.js";
import { categoriesDelete } from "@superbuilders/oneroster/funcs/categoriesDelete.js";
...
async function run() {
  const res = await categoriesDelete(oneRoster, {
    sourcedId: "<id>",
  });
