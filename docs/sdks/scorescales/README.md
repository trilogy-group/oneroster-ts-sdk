...
* [list](#list) - Get all score scales
* [create](#create) - Create a new score scale
* [get](#get) - Get a specific score scale
* [update](#update) - Update an existing score scale
* [delete](#delete) - Delete a score scale
...
async function run() {
  const result = await oneRoster.scoreScales.create({
    scoreScale: {
      status: "tobedeleted",
      title: "<value>",
      type: "<value>",
...
```typescript
import { OneRosterCore } from "@superbuilders/oneroster/core.js";
import { scoreScalesCreate } from "@superbuilders/oneroster/funcs/scoreScalesCreate.js";
...
async function run() {
  const res = await scoreScalesCreate(oneRoster, {
    scoreScale: {
      status: "tobedeleted",
      title: "<value>",
      type: "<value>",
...
async function run() {
  const result = await oneRoster.scoreScales.get({
    sourcedId: "<id>",
  });
...
```typescript
import { OneRosterCore } from "@superbuilders/oneroster/core.js";
import { scoreScalesGet } from "@superbuilders/oneroster/funcs/scoreScalesGet.js";
...
async function run() {
  const res = await scoreScalesGet(oneRoster, {
    sourcedId: "<id>",
  });
...
async function run() {
  const result = await oneRoster.scoreScales.update({
    sourcedId: "<id>",
    requestBody: {
      scoreScale: {
        status: "active",
...
```typescript
import { OneRosterCore } from "@superbuilders/oneroster/core.js";
import { scoreScalesUpdate } from "@superbuilders/oneroster/funcs/scoreScalesUpdate.js";
...
async function run() {
  const res = await scoreScalesUpdate(oneRoster, {
    sourcedId: "<id>",
    requestBody: {
      scoreScale: {
        status: "active",
...
async function run() {
  await oneRoster.scoreScales.delete({
    sourcedId: "<id>",
  });
...
```typescript
import { OneRosterCore } from "@superbuilders/oneroster/core.js";
import { scoreScalesDelete } from "@superbuilders/oneroster/funcs/scoreScalesDelete.js";
...
async function run() {
  const res = await scoreScalesDelete(oneRoster, {
    sourcedId: "<id>",
  });
