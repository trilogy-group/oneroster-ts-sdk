...
* [getAll](#getall) - Get all results
* [create](#create) - Create a new result
* [get](#get) - Get a specific result
* [update](#update) - Update an existing result
* [delete](#delete) - Delete a result
* [createForLineItem](#createforlineitem) - Create a new result for a line item
...
async function run() {
  const result = await oneRoster.results.getAll();
...
async function run() {
  const res = await resultsGetAll(oneRoster);
...
async function run() {
  const result = await oneRoster.results.create({
    result: {
      status: "tobedeleted",
      lineItem: {
        sourcedId: "<id>",
...
async function run() {
  const res = await resultsCreate(oneRoster, {
    result: {
      status: "tobedeleted",
      lineItem: {
        sourcedId: "<id>",
...
async function run() {
  const result = await oneRoster.results.get({
    sourcedId: "<id>",
  });
...
async function run() {
  const res = await resultsGet(oneRoster, {
    sourcedId: "<id>",
  });
...
async function run() {
  const result = await oneRoster.results.update({
    sourcedId: "<id>",
    requestBody: {
      result: {
        status: "active",
...
async function run() {
  const res = await resultsUpdate(oneRoster, {
    sourcedId: "<id>",
    requestBody: {
      result: {
        status: "active",
...
async function run() {
  await oneRoster.results.delete({
    sourcedId: "<id>",
  });
...
async function run() {
  const res = await resultsDelete(oneRoster, {
    sourcedId: "<id>",
  });
...
async function run() {
  const result = await oneRoster.results.createForLineItem({
    sourcedId: "<id>",
    requestBody: {
      results: [
        {
...
async function run() {
  const res = await resultsCreateForLineItem(oneRoster, {
    sourcedId: "<id>",
    requestBody: {
      results: [
        {
