...
* [getAll](#getall) - Get all teachers
* [get](#get) - Get a specific teacher
* [getClasses](#getclasses) - Get classes for a teacher
...
async function run() {
  const result = await oneRoster.teachers.getAll();
...
import { teachersGetAll } from "@superbuilders/oneroster/funcs/teachersGetAll.js";
...
async function run() {
  const res = await teachersGetAll(oneRoster);
...
async function run() {
  const result = await oneRoster.teachers.get({
    sourcedId: "<id>",
  });
...
```typescript
import { OneRosterCore } from "@superbuilders/oneroster/core.js";
import { teachersGet } from "@superbuilders/oneroster/funcs/teachersGet.js";
...
async function run() {
  const res = await teachersGet(oneRoster, {
    sourcedId: "<id>",
  });
...
async function run() {
  const result = await oneRoster.teachers.getClasses({
    teacherSourcedId: "<id>",
  });
...
```typescript
import { OneRosterCore } from "@superbuilders/oneroster/core.js";
import { teachersGetClasses } from "@superbuilders/oneroster/funcs/teachersGetClasses.js";
...
async function run() {
  const res = await teachersGetClasses(oneRoster, {
    teacherSourcedId: "<id>",
  });
