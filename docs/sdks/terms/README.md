...
* [list](#list) - Get all terms
* [get](#get) - Get a specific term
* [getGradingPeriods](#getgradingperiods) - Get grading periods for a term
* [getClasses](#getclasses) - Get classes for a term
...
async function run() {
  const result = await oneRoster.terms.list();
...
import { termsList } from "@superbuilders/oneroster/funcs/termsList.js";
...
async function run() {
  const res = await termsList(oneRoster);
...
async function run() {
  const result = await oneRoster.terms.get({
    sourcedId: "<id>",
  });
...
```typescript
import { OneRosterCore } from "@superbuilders/oneroster/core.js";
import { termsGet } from "@superbuilders/oneroster/funcs/termsGet.js";
...
async function run() {
  const res = await termsGet(oneRoster, {
    sourcedId: "<id>",
  });
...
async function run() {
  const result = await oneRoster.terms.getGradingPeriods({
    termSourcedId: "<id>",
  });
...
```typescript
import { OneRosterCore } from "@superbuilders/oneroster/core.js";
import { termsGetGradingPeriods } from "@superbuilders/oneroster/funcs/termsGetGradingPeriods.js";
...
async function run() {
  const res = await termsGetGradingPeriods(oneRoster, {
    termSourcedId: "<id>",
  });
...
async function run() {
  const result = await oneRoster.terms.getClasses({
    termSourcedId: "<id>",
  });
...
```typescript
import { OneRosterCore } from "@superbuilders/oneroster/core.js";
import { termsGetClasses } from "@superbuilders/oneroster/funcs/termsGetClasses.js";
...
async function run() {
  const res = await termsGetClasses(oneRoster, {
    termSourcedId: "<id>",
  });
