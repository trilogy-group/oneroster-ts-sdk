...
* [list](#list) - Get all line items
* [create](#create) - Create a new line item
* [get](#get) - Get a specific line item
* [update](#update) - Update an existing line item
* [delete](#delete) - Delete a line item
...
async function run() {
  const result = await oneRoster.lineItems.list();
...
import { lineItemsList } from "@superbuilders/oneroster/funcs/lineItemsList.js";
...
async function run() {
  const res = await lineItemsList(oneRoster);
...
async function run() {
  const result = await oneRoster.lineItems.create({
    lineItem: {
      status: "active",
      title: "<value>",
...
```typescript
import { OneRosterCore } from "@superbuilders/oneroster/core.js";
import { lineItemsCreate } from "@superbuilders/oneroster/funcs/lineItemsCreate.js";
...
async function run() {
  const res = await lineItemsCreate(oneRoster, {
    lineItem: {
      status: "active",
      title: "<value>",
      assignDate: new Date("2025-07-17T09:24:39.378Z"),
...
async function run() {
  const result = await oneRoster.lineItems.get({
    sourcedId: "<id>",
  });
...
```typescript
import { OneRosterCore } from "@superbuilders/oneroster/core.js";
import { lineItemsGet } from "@superbuilders/oneroster/funcs/lineItemsGet.js";
...
async function run() {
  const res = await lineItemsGet(oneRoster, {
    sourcedId: "<id>",
  });
...
async function run() {
  await oneRoster.lineItems.update({
    sourcedId: "<id>",
    requestBody: {
      lineItem: {
        status: "active",
...
```typescript
import { OneRosterCore } from "@superbuilders/oneroster/core.js";
import { lineItemsUpdate } from "@superbuilders/oneroster/funcs/lineItemsUpdate.js";
...
async function run() {
  const res = await lineItemsUpdate(oneRoster, {
    sourcedId: "<id>",
    requestBody: {
      lineItem: {
        status: "active",
...
async function run() {
  await oneRoster.lineItems.delete({
    sourcedId: "<id>",
  });
...
```typescript
import { OneRosterCore } from "@superbuilders/oneroster/core.js";
import { lineItemsDelete } from "@superbuilders/oneroster/funcs/lineItemsDelete.js";
...
async function run() {
  const res = await lineItemsDelete(oneRoster, {
    sourcedId: "<id>",
  });
