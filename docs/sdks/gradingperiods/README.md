...
* [getAll](#getall) - Get all grading periods
* [create](#create) - Create a new grading period
* [get](#get) - Get a specific grading period
* [update](#update) - Update a grading period
* [delete](#delete) - Delete a grading period
* [createForTerm](#createforterm) - Create a new grading period for a term
...
async function run() {
  const result = await oneRoster.gradingPeriods.getAll();
...
import { gradingPeriodsGetAll } from "@superbuilders/oneroster/funcs/gradingPeriodsGetAll.js";
...
async function run() {
  const res = await gradingPeriodsGetAll(oneRoster);
...
async function run() {
  const result = await oneRoster.gradingPeriods.create();
...
```typescript
import { OneRosterCore } from "@superbuilders/oneroster/core.js";
import { gradingPeriodsCreate } from "@superbuilders/oneroster/funcs/gradingPeriodsCreate.js";
...
async function run() {
  const res = await gradingPeriodsCreate(oneRoster);
...
async function run() {
  const result = await oneRoster.gradingPeriods.get({
    sourcedId: "<id>",
  });
...
```typescript
import { OneRosterCore } from "@superbuilders/oneroster/core.js";
import { gradingPeriodsGet } from "@superbuilders/oneroster/funcs/gradingPeriodsGet.js";
...
async function run() {
  const res = await gradingPeriodsGet(oneRoster, {
    sourcedId: "<id>",
  });
...
async function run() {
  const result = await oneRoster.gradingPeriods.update({
    sourcedId: "<id>",
  });
...
```typescript
import { OneRosterCore } from "@superbuilders/oneroster/core.js";
import { gradingPeriodsUpdate } from "@superbuilders/oneroster/funcs/gradingPeriodsUpdate.js";
...
async function run() {
  const res = await gradingPeriodsUpdate(oneRoster, {
    sourcedId: "<id>",
  });
...
async function run() {
  const result = await oneRoster.gradingPeriods.delete({
    sourcedId: "<id>",
  });
...
```typescript
import { OneRosterCore } from "@superbuilders/oneroster/core.js";
import { gradingPeriodsDelete } from "@superbuilders/oneroster/funcs/gradingPeriodsDelete.js";
...
async function run() {
  const res = await gradingPeriodsDelete(oneRoster, {
    sourcedId: "<id>",
  });
...
async function run() {
  const result = await oneRoster.gradingPeriods.createForTerm({
    termSourcedId: "<id>",
    requestBody: {
      academicSession: {
        title: "<value>",
...
```typescript
import { OneRosterCore } from "@superbuilders/oneroster/core.js";
import { gradingPeriodsCreateForTerm } from "@superbuilders/oneroster/funcs/gradingPeriodsCreateForTerm.js";
...
async function run() {
  const res = await gradingPeriodsCreateForTerm(oneRoster, {
    termSourcedId: "<id>",
    requestBody: {
      academicSession: {
        title: "<value>",
