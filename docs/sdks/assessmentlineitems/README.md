...
* [getAll](#getall) - Get all Assessment Line Items
* [create](#create) - Create an Assessment Line Item
* [get](#get) - Get an Assessment Line Item
* [update](#update) - Update an Assessment Line Item
* [delete](#delete) - Delete an Assessment Line Item
