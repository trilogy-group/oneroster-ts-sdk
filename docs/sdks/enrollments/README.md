...
* [getAll](#getall) - Get all enrollments
* [create](#create) - Create a new enrollment
* [get](#get) - Get a specific enrollment
* [update](#update) - Update an enrollment
* [delete](#delete) - Delete an enrollment
* [getForClass](#getforclass) - Get enrollments for a specific class in a school
...
async function run() {
  const result = await oneRoster.enrollments.getAll();
...
async function run() {
  const res = await enrollmentsGetAll(oneRoster);
...
async function run() {
  const result = await oneRoster.enrollments.create({
    enrollment: {
      role: "teacher",
...
async function run() {
  const res = await enrollmentsCreate(oneRoster, {
    enrollment: {
      role: "teacher",
      beginDate: "2024-01-01",
      endDate: "2024-01-01",
...
async function run() {
  const result = await oneRoster.enrollments.get({
    sourcedId: "<id>",
  });
...
async function run() {
  const res = await enrollmentsGet(oneRoster, {
    sourcedId: "<id>",
  });
...
async function run() {
  const result = await oneRoster.enrollments.update({
    sourcedId: "<id>",
    requestBody: {
      enrollment: {
        sourcedId: "<id>",
...
async function run() {
  const res = await enrollmentsUpdate(oneRoster, {
    sourcedId: "<id>",
    requestBody: {
      enrollment: {
        sourcedId: "<id>",
...
async function run() {
  await oneRoster.enrollments.delete({
    sourcedId: "<id>",
  });
...
async function run() {
  const res = await enrollmentsDelete(oneRoster, {
    sourcedId: "<id>",
  });
...
async function run() {
  const result = await oneRoster.enrollments.getForClass({
    schoolSourcedId: "<id>",
    classSourcedId: "<id>",
  });
...
async function run() {
  const res = await enrollmentsGetForClass(oneRoster, {
    schoolSourcedId: "<id>",
    classSourcedId: "<id>",
  });
